  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div className="bg-black text-gray-500 p-8 rounded shadow-lg w-1/3">
        <h2 className="text-xl font-bold mb-4 text-white">Customer Register</h2>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="flex justify-end space-x-2">
            ...
            <span className="absolute inset-px z-10 grid place-items-center rounded-lg bg-black bg-gradient-to-t from-neutral-800 text-white">Register</span>
